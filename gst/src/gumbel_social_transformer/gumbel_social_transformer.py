...
from gst.src.gumbel_social_transformer.utils import _get_clones
...
class GumbelSocialTransformer(nn.Module):
    def __init__(self, d_motion, d_model, nhead_nodes, nhead_edges, nlayer, dim_feedforward=512, dim_hidden=32, \
        ...
        if ghost:
            ...
            from gst.src.gumbel_social_transformer.edge_selector_ghost import EdgeSelector
            from gst.src.gumbel_social_transformer.node_encoder_layer_ghost import NodeEncoderLayer
        else:
            print("No ghost version.")
            from gst.src.gumbel_social_transformer.edge_selector_no_ghost import EdgeSelector
            from gst.src.gumbel_social_transformer.node_encoder_layer_no_ghost import NodeEncoderLayer
        if nhead_edges != 0:
